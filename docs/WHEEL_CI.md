...
Actions are pinned to full commits. This workflow has passed actionlint 1.7.12
locally; no hosted run or platform result is claimed yet.
...
OpenCV parity suite. Python 3.11–3.13 additionally run framework integration and
training tests against the pinned Ultralytics commit and numerical dependencies.
